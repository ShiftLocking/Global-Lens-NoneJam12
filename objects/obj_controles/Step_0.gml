...
if (surface_exists(_target.surface))
{
    ...
    var _sprite_width = sprite_get_width(spr_pause) * _scalex;
    var _sprite_height = sprite_get_height(spr_pause) * _scaley;
    
    draw_sprite_ext(spr_pause, 0, width / 2, height / 2, _scalex, _scaley, 0, c_white, 1);
    ...
    var s1 = detection(_i);
    draw_sprite_ext(s1.sprite, s1.subming, width / 2 + _sprite_width / 5, height / 2 + _sprite_height / 2 + sprite_get_height(s1.sprite) / 2, .8, .8, 0, c_white, 1);
    ...
    load_options_keybinds(struct, fnt_pause, width / 2 - _sprite_width / 6, height / 2 - _sprite_height / 3, _sprite_width / 2);
